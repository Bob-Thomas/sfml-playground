...
void World::loadTextures()
{
    ...
    mTextures.load(Textures::Avenger, "resources/textures/avenger.png");
    mTextures.load(Textures::Desert, "resources/textures/desert.png");

    mTextures.load(Textures::Bullet, "resources/textures/bullet.png");
    mTextures.load(Textures::Missile, "resources/textures/missile.png");

    mTextures.load(Textures::HealthRefill, "resources/textures/healthRefill.png");
    mTextures.load(Textures::MissileRefill, "resources/textures/missileRefill.png");
